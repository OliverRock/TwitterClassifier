...
# create the corpus from the training set. With a limit to the number of tweets to learn from, processing
# all 1 000 000 takes along time
corpus = load_corpus(70000)
...
classifyPerson("BarackObama_tweets.csv", word_dictionary)